...
{
    /// <summary>
    /// Manages a contiguous block of memory. Calls purge with itself when it is purged.
    /// </summary>
    public class FixedSizeBuffer : PooledResource<FixedSizeBuffer>
    {
        ...
        /// <summary>
        /// Reset state and calls purge with it's buffer, indicating that any segments using that address are no longer valid.
        /// </summary>
